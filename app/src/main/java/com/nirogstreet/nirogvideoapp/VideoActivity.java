...
public class VideoActivity extends AppCompatActivity {
    ...
    private final IRtcEngineEventHandler mRtcEventHandler = new IRtcEngineEventHandlerEx() {

        public void onJoinChannelSuccess(final String channel, final int uid, int elapsed) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Log.e(TAG, "Join channel success" + channel + "==" + uid);
                }
            });
        }
    ...
    private void joinVideoChannel() {
        ...
        mRtcEngine.joinChannel(token, "NirogVideoApp", "Extra Optional Data", 0);
    }
